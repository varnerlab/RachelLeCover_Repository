...
dilution_factor = .93
  ...
  experimental_input_array[1]    = 0.0025*1000*dilution_factor  # TFPI
  experimental_input_array[2]    = 0.02*1000*dilution_factor    # FV
  experimental_input_array[3]    = 0.0007*1000*dilution_factor  # FVIII
  experimental_input_array[4]    = 0.09*1000*dilution_factor    # FIX
  experimental_input_array[5]    = 0.17*1000*dilution_factor    # FX
  experimental_input_array[6]    = 0.093*1000*dilution_factor   # fXIII
	  tafi_mean_level = 95.2
  experimental_input_array[7]  = tafi_mean_level*dilution_factor          # 7 TAFI
  # ====================================================================================== #
