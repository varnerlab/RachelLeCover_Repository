...
function main(xml_filename, desired_species_filename,output_file_name)
	...
	generate_plotting_code(to_plot, output_file_name, compound_dict,comparment_name_array, 0,10,.02)
...
function generate_plotting_code(to_plot, output_file_name, compound_dict,comparment_name_array, tstart, tend, step)
...
main("debug/PBPK_AST.xml", "desired_species.txt", "src/runModel.jl")
