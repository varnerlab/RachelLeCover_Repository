...
function test_model()
	outputfile = "outputJun3parallel/poetsinfo.txt"
	touch(outputfile)
	...
	for index in collect(1:number_of_subdivisions)
		...
		#run JuPOETS
		(EC,PC,RA) = estimate_ensemble(multidimensionalMSE_usingparallel,neighbor_function,acceptance_probability_function,cooling_function,initial_parameter_array;rank_cutoff=4,maximum_number_of_iterations=5,show_trace=true)
		  # Package -
