...
function validate_model_oneset(set)
	...
	for j in collect(1:6)
		pathToParams = string("parameterEstimation/LOOCVSavingAllParams_2017_02_06_low_acc/bestParamSetsFromLOOCV", set, "excluded.txt")
		savestr = string("figures/LOOCVValidation_using_params_wo", set, "On_set_", j,"-2017_02_06_low_acc.pdf")
		currdata = allexperimentaldata[j]
		runModelWithMultipleParams(pathToParams, pathsToData[j],j,savestr)
	end
end
