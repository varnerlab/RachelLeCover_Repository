...
#	
    ...
    control_vector[6] = min(1-max(inhibition_term,inhibition_term_TFPI),FVIII_control)
    control_vector[7] = min(1-max(inhibition_term,inhibition_term_TFPI),FVIII_control)
