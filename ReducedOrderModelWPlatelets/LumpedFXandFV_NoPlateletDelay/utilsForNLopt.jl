...
function objectiveForNLOpt(params::Vector, grad::Vector)
	...
	f = open("parameterEstimation/NLoptNM_2017_02_28.txt", "a+")
...
function attemptOptimizationNLOpt()
	...
	lowerbounds = fill(1E-9, 1, numvars)
	lowerbounds[40] = 1E-4 #lower bound on aida
	...
	upperbounds[40] = 100.0 #upper bound on aida
