function buildCoagulationModelDictionary()
    ...
    push!(kinetic_parameter_vector,7200*2.0)       #  k_trigger
    push!(kinetic_parameter_vector,650)       # 1 K_trigger
    push!(kinetic_parameter_vector,4.5)        # 2 k_amplification
    push!(kinetic_parameter_vector,120)       # 3 K_FII_amplification
    push!(kinetic_parameter_vector,2.0)        # 4 k_APC_formation
    push!(kinetic_parameter_vector,30/20.0)         # 5 K_PC_formation
    push!(kinetic_parameter_vector,0.2*10000)        # 6 k_inhibition
    push!(kinetic_parameter_vector,1200/10.0)       # 7 K_FIIa_inhibition
    push!(kinetic_parameter_vector,0.01)     # 8 k_inhibition_ATIII
    ...
    push!(kinetic_parameter_vector, 63.5*60*10000 )#14 k_amp_prothombinase from reaction 18 in Diamond 2010
    push!(kinetic_parameter_vector, 1.6E-6*10.0^6*10000) #13 K_FII_amp_prothombinase
    push!(kinetic_parameter_vector, 5.0/10.0) #k_amp_active_factors
    ...
    # Amplification -
    push!(control_parameter_vector,10.0)        # 6 15 alpha_amplification_FIIa = control_parameter_vector[6]
    ...
    # APC generation -
    push!(control_parameter_vector,200.0)        # 12 21 alpha_shutdown_APC = control_parameter_vector[12]
   ...
   #platlet controls
    ...
    push!(scaling_parameter_vector,3.0)        # 0 Time scale 
