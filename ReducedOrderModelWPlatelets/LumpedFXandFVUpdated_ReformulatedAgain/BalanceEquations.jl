...
#	
	...
	alpha_factor_amplification = control_parameter_vector[21]
	order_factor_amplification = control_parameter_vector[22]
    ...
    control_vector[1] = min(initiation_trigger_term,factor_amplification_term)
    control_vector[2] = 1-max(inhibition_term,inhibition_term_TFPI)
    control_vector[3] = shutdown_term
    control_vector[4] = 1
    control_vector[5] = 1
    #control_vector[6] = min(inhibition_term,inhibition_term_TFPI)
    control_vector[6] = 1-max(inhibition_term,inhibition_term_TFPI)
    control_vector[7] = 1-max(inhibition_term,inhibition_term_TFPI)
    ...
    k_PT_deg = kinetic_parameter_vector[19]
...
#	close(f)
	...
	dxdt_total[11] = modified_rate_vector[5]-k_PT_deg*PROTHOMBINASE_PLATELETS #Prothromibase_platelets
