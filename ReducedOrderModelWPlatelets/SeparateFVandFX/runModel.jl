...
function runModel(TSTART,Ts,TSTOP)
	...
	reshaped_IC = vec(reshape(initial_condition_vector,13,1)) #may need to cast to vector for Sundials
...
function makeLoopPlots(t,x)
	names = ["FII", "FIIa", "PC", "APC", "ATII", "TM", "TRIGGER", "EPS", "FV", "FVa", "FX", "FXa", "Prothombinase"]
