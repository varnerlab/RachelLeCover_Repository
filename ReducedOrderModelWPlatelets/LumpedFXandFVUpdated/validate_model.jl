...
function validate_model()
	...
	for j in collect(1:6)
		pathToParams = string("parameterEstimation/LOOCVSavingAllParams_2016_12_23_Take2/bestParamSetsFromLOOCV", j, "excluded.txt")
		savestr = string("figures/LOOCVValidation_Predicting_set_", j, "-2016_12_26.pdf")
