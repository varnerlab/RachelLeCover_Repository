function buildCoagulationModelDictionary()
    ...
    push!(kinetic_parameter_vector,7200*1.25)       #  k_trigger
    ...
    push!(kinetic_parameter_vector, 63.5*60*100*2 )#14 k_amp_prothombinase from reaction 18 in Diamond 2010
