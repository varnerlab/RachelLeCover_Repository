...
function test_model(initial_parameter_array, selected_idxs)
	outputfile = string("parameterEstimation/LOOCVSavingAllParams_2016_12_26/POETS_selectedindices",string(selected_idxs) ,".txt")
...
function doLOOCV()
	...
	for j in collect(1: size(experimental_indices,1))
		...
		bestparams_output = string("parameterEstimation/LOOCVSavingAllParams_2016_12_26/bestParamSetsFromLOOCV",j, "excluded.txt")
