...
function runModelForSobolParallel()
	allparams = readdlm("sensitivity/sobol_params_pm50_N500_04_20_2017.txt", ' ', Float64);
	...
	@sync @parallel for j in collect(1:nworkers())
		f = open(string("sensitivity/tPA_2_AUCForSobolPM50PercentN500_", myid()-1, "_of_",nworkers(), ".txt"), "a+")
