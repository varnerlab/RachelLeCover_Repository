...
function attemptOptimizationNLOpt()
   ...
   kinetic_parameter_vector = Float64[]
    push!(kinetic_parameter_vector,7200*10)       #  k_trigger
    ...
    push!(kinetic_parameter_vector, 2400.0) #13 k_complex
    push!(kinetic_parameter_vector, 63.5*60*500 )#14 k_amp_prothombinase from reaction 18 in Diamond 2010
    ...
    push!(kinetic_parameter_vector, 1.0) #k_PT_deg
    # Control parameters -
