...
function calculateHeartRate(data,params,savestr)
	...
	for time in t
		...
		tout, res = ODE.ode23(bf, bfprev,tspan,abstol = 1E-8, reltol=1E-8)
	...
	#PyPlot.close()
	#filename = "/home/rachel/Documents/optimization/sensitivityanalysis/cluster1figure/timedatausingdifferentparamsetsforpatients27192-3078-05-03-16-47n.txt"
	MSE = calculateMSE(tdata, data[:_HR_], t, heartRate2012)
	#saveDataToFile(t,heartRate2012,filename)
	return MSE
...
function calculateHeartRateForSaving(data,params,savestr,datasavestr)
	...
	global alpha = params[1]
	global N = params[2]
	global M = params[3]
	global k1 = params[4]
	global k2 = params[5]
	global tau1 = params[6]
	global tau2 = params[7]
	global tauach = params[8]
	global taunor = params[9]
	global beta = params[10]
	global h0 = params[11]
	global Mnor = params[12]
	global Mach = params[13]
