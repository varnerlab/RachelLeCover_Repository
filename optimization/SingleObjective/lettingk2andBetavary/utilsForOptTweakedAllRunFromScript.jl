...
function parallel_calculateTotalMSENL(x::Vector, grad::Vector)
	...
	tic()
	usefulpatients = 273.0
	outputdir = "/home/rachel/Documents/work/optimization/SingleObjective/lettingk2andBetavary/outputAug30/"
	#inputdir = "/home/rachel/Documents/modelingHR/LinkedRecordsTimeData10min/"
	...
	#allpatients = readdir(inputdir)
	clusterCounter = "allpatients"
	datasavestr = string(outputdir,"cluster",clusterCounter, "thread", myid(), "usefuldatatol1E-8Take1.txt")
	paramssavestr= string(outputdir,"cluster",clusterCounter, "thread", myid(),"paramstolAll1E-8Take1.txt")
	touch(datasavestr)
	touch(paramssavestr)
