using DataFrames
include("OlufsenModel2011calcHRSensitivites.jl")
...
function processNumericalData(filename)
	...
	writetable("tempoutputSDb.csv", df)
	dfnew = readtable("tempoutputSDb.csv", separator=',')
	return dfnew, units
end
...
function calculateS0(DFhr,DFdxdp,changableparams)
	tic()
	S0 = Float64[]
	@show DFhr
	@show DFdxdp
...
function doSensitivitiesMakeDFs()
	...
	inputdir = "/home/rachel/Documents/modelingHR/LinkedRecordsTimeData10min/"
	outputdir = "ReallyFixedMathBestParams/"
